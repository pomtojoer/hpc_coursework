...
mpiexec -np 9 ./Solve --Lx=1 --Ly=1 --Nx=161 --Ny=161 --Px=3 --Py=3 --dt=0.0005 --T=2.0 --Re=1000
mpiexec -np 9 ./Solve --Lx=1 --Ly=1 --Nx=161 --Ny=161 --Px=3 --Py=3 --dt=0.0005 --T=3.0 --Re=3200
